 ...
 * @author senvi
 */
public class regin extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     addd  c = new addd();
     c.submitdata(dcname,paname,pnumber,pemail,pdate,ptime,"neurology");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(regin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
